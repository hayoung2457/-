...
# 기말과제를 수행하면서 완전하지 않은 데이터를 학습, 예측시키는 과정을 이해할 수 있었습니다.
# 어떤 regression을 사용할지 고민하면서 수업에서 배운 방식 외에도 다양한 regression 방식을 알 수 있었습니다.
# 또 취업률 예측과 관련해서는, 주제를 먼저 정하고 데이터를 구했던터라 데이터의 양이 많이 부족했던 점이 아쉽긴 하지만
# 한편으로는 데이터량이 머신러닝에 얼마나 많이 관여하는지 직접 배울 수 있어서 도움이 되었습니다.
# 앞으로 연구를 진행하면서 이번 수업에서 배운 머신러닝을 스스로 활용할 수 있을 것이라고 기대하고 있습니다.
# 기말 과제에서 성적 분포와 취업률을 모두 학습시키고 예측하려고 했는데 데이터량의 문제로 취업률의 예측 정확도가 떨어지므로,
# 만점을 받기는 어려울 것이라고 생각해서 A- ~ A0의 성적을 부여하고 싶습니다. 